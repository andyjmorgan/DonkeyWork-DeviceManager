...
echo -e "${YELLOW}[2/6] Preparing installation directory...${NC}"
...
echo -e "${YELLOW}[3/6] Checking OSQuery installation...${NC}"
...
if [ "$API_BASE_URL" != "https://devicemanager.donkeywork.dev" ]; then
    echo -e "${YELLOW}[5/6] Updating API URL in configuration...${NC}"
    ...
    echo -e "${YELLOW}[5/6] Configuration file already present${NC}"
